...
export function WorkspaceRouteRenderer({
  ...
  const { activeDashboardId, activeView, addWorkflowStepDraft, analysisPages, databaseBackend, deleteWorkflowStepDraft,
    ...
    selectedRequestId, selectedWorkflow, selectLoadCase, selectProject, selectRequest, setAnalysisPages,
