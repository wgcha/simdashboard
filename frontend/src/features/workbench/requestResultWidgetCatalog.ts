...
import { semanticWidgetTypeLabels } from '../../shared/components/semanticLabels.ts'
...
export const REQUEST_RESULT_WIDGET_CATALOG: readonly RequestResultWidgetCatalogItem[] = [
  ...
  { type: 'video', label: semanticWidgetTypeLabels.video, description: '변형·응력 애니메이션 결과를 표시합니다.', group: '영상', data_contracts: ['MEDIA_ASSET'], variable_key: 'animation' },
